...
> = NeedsApproval extends false
  ? F
  : Schema.Union<readonly [F, typeof ApprovalDenied]>;
...
> {
  ...
  readonly handler: (
    ...
    O["Type"],
    FailureSchemaOf<F, NeedsApproval>["Type"],
    R | ApprovalRequirement<NeedsApproval>
  >;
}
...
export type RequirementsOf<C> =
  C extends Capability<
    ...
    infer _NeedsApproval
  >
    ? R | ApprovalRequirement<_NeedsApproval>
    : never;
...
export function defineCapability<
  ...
  F extends PlainSchema,
  R = never,
>(name: N, options: DefineOptions<I, O, F, R>): Capability<N, I, O, F, R>;
export function defineCapability<
  const N extends string,
  I extends InputSchema,
  O extends PlainSchema,
...
>(
  name: N,
  options: DefineOptions<I, O, F, R, true> & {
    readonly needsApproval: true;
  }
): Capability<N, I, O, F, R, true>;
export function defineCapability<
  const N extends string,
  I extends InputSchema,
  O extends PlainSchema,
...
>(
  name: N,
  options: DefineOptions<I, O, F, R, NeedsApproval>
): Capability<N, I, O, F, R, NeedsApproval>;
export function defineCapability<
  const N extends string,
  I extends InputSchema,
  O extends PlainSchema,
...
>(
  name: N,
  options: DefineOptions<I, O, F, R, boolean>
): Capability<N, I, O, F, R, boolean>;
export function defineCapability<
  const N extends string,
  I extends InputSchema,
  O extends PlainSchema,
